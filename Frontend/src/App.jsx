...
import ClubHub from './pages/student/ClubHub';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<ProtectedRoute roles={['student']} />}>
          ...
          <Route path="/dashboard/student/clubs/:clubId" element={<ClubHub />} />
          <Route path="/dashboard/student/calendar" element={<EventCalendar />} />
        ...
        <Route element={<ProtectedRoute roles={['faculty']} />}>
          ...
          <Route path="/dashboard/faculty/clubs/:clubId" element={<ClubHub />} />
          <Route path="/dashboard/faculty/calendar" element={<EventCalendar />} />
        ...
        <Route element={<ProtectedRoute roles={['admin']} />}>
          ...
          <Route path="/dashboard/admin/clubs/:clubId" element={<ClubHub />} />
          <Route path="/dashboard/admin/calendar" element={<EventCalendar />} />
